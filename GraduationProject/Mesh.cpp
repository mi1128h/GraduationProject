...
CPlaneMeshDiffused::CPlaneMeshDiffused(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, XMFLOAT4 xmf4Color) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CDiffusedVertex);
	m_d3dPrimitiveTopology = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	...
	pVertices[0] = CDiffusedVertex(XMFLOAT3(+fx, -fy, 0.0f), Vector4::Add(xmf4Color, color));
	pVertices[1] = CDiffusedVertex(XMFLOAT3(+fx, +fy, 0.0f), Vector4::Add(xmf4Color, color));
	pVertices[2] = CDiffusedVertex(XMFLOAT3(-fx, -fy, 0.0f), Vector4::Add(xmf4Color, color));
	pVertices[3] = CDiffusedVertex(XMFLOAT3(-fx, -fy, 0.0f), Vector4::Add(xmf4Color, color));
	pVertices[4] = CDiffusedVertex(XMFLOAT3(+fx, +fy, 0.0f), Vector4::Add(xmf4Color, color));
	pVertices[5] = CDiffusedVertex(XMFLOAT3(-fx, +fy, 0.0f), Vector4::Add(xmf4Color, color));

	//pVertices[0] = CDiffusedVertex(XMFLOAT3(+fx, -fy, 0.0f),xmf4Color);
	//pVertices[1] = CDiffusedVertex(XMFLOAT3(+fx, +fy, 0.0f),xmf4Color);
	//pVertices[2] = CDiffusedVertex(XMFLOAT3(-fx, -fy, 0.0f),xmf4Color);
	//pVertices[3] = CDiffusedVertex(XMFLOAT3(-fx, -fy, 0.0f),xmf4Color);
	//pVertices[4] = CDiffusedVertex(XMFLOAT3(+fx, +fy, 0.0f),xmf4Color);
	//pVertices[5] = CDiffusedVertex(XMFLOAT3(-fx, +fy, 0.0f),xmf4Color);
