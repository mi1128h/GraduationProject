...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define ANIM_LOOP 101
#define ANIM_ONE 102
class CBillAnimObject : public CGameObject
{
public:
	CBillAnimObject(int nMeshes = 1);
	virtual ~CBillAnimObject();

	virtual void Animate(float fElapsedTime, CCamera* pCamrea = NULL);
	virtual void SetLookAt(XMFLOAT3& xmf3Target);
	virtual void UpdateShaderVariables(ID3D12GraphicsCommandList* pd3dCommandList);

	virtual void SetAnimIndex(int min, int num) { MinIndex = min;  m_nTexCount = num; }
	virtual void SetAnimState(int state) { ANIM_STATE = state; }
public:
	int							MinIndex = 0;
	int							m_nTexCount = 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CBulletObject : public CBillAnimObject
{
public:
	...
	// 총알이 발사된 상태인지 판단
	bool CheckFire();
	void ChangeBullet(int ChangeIndex);
