...
public:
	...
	virtual void UpdateTextureShaderVariable(ID3D12GraphicsCommandList* pd3dCommandList, XMFLOAT4X4* pxmf4x4Texture);
...
class CAnimateEffectObject : public CGameObject
{
public:
